...
-(void)setYLabels:(NSArray *)yLabels
{
	...
	while (num > 0) {
		CGFloat chartCavanHeight = self.frame.size.height - chartLineMargin * 2 - 40.0 ;
...
-(void)setXLabels:(NSArray *)xLabels{
    _xLabels = xLabels;
    _xLabelWidth = (self.frame.size.width - chartLineMargin - 30.0 - ([xLabels count] -1) * xLabelMargin)/5.0;
